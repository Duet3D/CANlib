...
constexpr float DefaultChamberTemperatureLimit = 100.0;
...
constexpr float DefaultBedHeaterPwmFaultLevel = 1.5;		// Raise a PWM fault if the	PWM accumulator divided by the expected PWM exceeds this value for long enough
constexpr float DefaultBedHeaterPwmFaultTime = 30.0;		// How many seconds we allow a heating excess pwm fault to persist
